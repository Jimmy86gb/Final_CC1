...
public class RequestsView {
    ...
    private VBox createColumn(String title, String bgColor, VBox internalContainer) {
        ...
        // CORRECCIÓN CSS: Hacemos que el VBox interno y el ScrollPane sean transparentes
    ...
    public void addReportCard(ReportDTO report, String targetPanel) {
        ...
        // VALIDACIONES NULL-SAFE: Si el DTO viene incompleto, muestra N/A en vez de dañar la tarjeta
